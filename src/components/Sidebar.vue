    ...
    <nav>
      <ul>
        <li v-for="item in sidebarItems" 
            ...
            :data-view="item.view"
            @click="currentView = item.view; $emit('view-change', item.view)">
